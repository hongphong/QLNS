            ...
            <div class="content">
            	...
            	<table width="100%" border="0" cellspacing="1" cellpadding="5" id="table" bgcolor="#e3e3e3">
                    <tr align="center" height="30" style="color:#000;">
                        ...
                        <td width="150"><strong style="margin-left:10px">Tên nhân viên</strong></td>
                        <td align="center"><strong>Đánh giá</strong></td>
                        <td width="150"><strong>Ngày đánh giá</strong></td>
                        <td width="150"><strong>Ngày tạo</strong></td>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="5" id="table">
                	<?php	
						...
						foreach ($query as $row):
							...
							$linkEdit = base_url().'hrm/employeelog/edit/'.$id.$request;
							$date     = $row->created;
							$dates    = 'Tháng <strong style="color:red;">'.$row->month.'/'.$row->year.'</strong>';
                    ?>
                    <tr align="center" height="30" bgcolor="<?php echo $bgcolor; ?>" id="ms">
                        ...
                        <td align="center" style="padding:3px;"><?= $comment ?></td>
                        <td width="150"><?= $dates ?></td>
                        <td width="150"><?= date("d/mY h:i:s", $date) ?></td>
	...
	$(document).ready(function() {
		...
		$(".deletemulti").click(function(){
			...
			if(confirm("Bạn muốn xóa những mục đã chọn này không ?")){	
				...
				$.post("<?php echo base_url().'hrm/employeedegree/deletemulti' ?>", { ids : val, table : TABLE } );	
			}
		});
	});
</script>
