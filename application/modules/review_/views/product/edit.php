            ...
            <div class="content">
            	...
            	<table width="100%" border="0" cellspacing="1" cellpadding="5" id="table" bgcolor="">
                    <tr height="30" style="color:#000;">
                        <td width="40%"><input type="text" name="input[name]" placeholder="Tên sản phẩm" value="<?= $query->name ?>"/></td>
                        <td align="30%"><input type="text" name="input[const]" placeholder="Giá mặc định" value="<?= $query->const ?>"/></td>
                        <td width="30%"><input type="text" name="input[result]" placeholder="Giá trị thực tế" value="<?= $query->result ?>"/></td>
                    </tr>
                    <tr height="30" style="color:#000;">
                        <td width="40%"><input type="text" name="input[weight]" placeholder="Trọng số" value="<?= $query->weight ?>"/></td>
                        <td align="30%"></td>
                        <td width="30%"></td>
                    </tr>
                    <tr height="30" style="color:#000;">
                        <td width="40%">
                        	<select name="input[gid]" id="gid" class="validate[required]">
