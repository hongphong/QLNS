            ...
            <div class="content">
            	...
            	<table width="100%" border="0" cellspacing="1" cellpadding="5" id="table" bgcolor="">
                    <tr height="30" style="color:#000;">
                        <td width="40%"><input type="text" name="unit[]" placeholder="Tên đơn vị"/></td>
                        <td align="30%"><input type="text" name="unit[]" placeholder="Tên đơn vị"/></td>
                        <td width="30%"><input type="text" name="unit[]" placeholder="Tên đơn vị"/></td>
                    </tr>
                    <tr height="30" style="color:#000;">
                        <td width="40%"><input type="text" name="unit[]" placeholder="Tên đơn vị"/></td>
                        <td align="30%"><input type="text" name="unit[]" placeholder="Tên đơn vị"/></td>
