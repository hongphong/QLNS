            ...
            <div class="content">
            	...
            	<table width="100%" border="0" cellspacing="1" cellpadding="5" id="table" bgcolor="#e3e3e3">
                    <tr align="center" height="30" style="color:#000;">
                        ...
                        <td align="left"><strong style="margin-left:10px">Tên đơn vị</strong></td>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="5" id="table">
                	<?php	
						...
						foreach ($query as $row):
							...
							$id 	  = $row->id;
							$title    = $row->unit;
							$value    = ($row->value)?$row->value:"Đang cập nhật";
							$linkEdit = base_url().'setting/unit/edit/'.$id;
                    ?>
	...
	$(document).ready(function() {
		...
		$(".deletemulti").click(function(){
			...
			if(confirm("Bạn muốn xóa những mục đã chọn này không ?")){	
				...
				$.post("<?php echo base_url().'setting/unit/deletemulti' ?>", { ids : val, table : TABLE } );	
			}
		});
	});
</script>
