...
<div class="pro-info wrap-main">
    ...
    <div>
    	...
    	<div>
            ...
            <div class="content">
            	<table width="80%" border="0" cellspacing="1" cellpadding="5" id="table" bgcolor="">
                    <tr height="30" style="color:#000;">
                        <td width="50%">
                        	<input style="width: 90%;" type="text" name="name" placeholder="Tên nhóm"/>
                        </td>
                        <td></td>
                    </tr>
                </table>
            ...
            <div class="content">
            	<table class="tbl-template-2 tbl_perm" width="80%">
            		<tr class="title">
                                    ...
                                    foreach ($arr_controller as $cID => $controller) {
                                       ...
                                       <td width="20%">
                                          ...
                                          foreach ($controller['child'] as $fID => $function) {
                                             ?>
                                             <p><label><input type="checkbox" name="perm[]" value="<?=$fID?>" class="c_child" /><?=$function['fun_name']?></label></p>
                                             <?
                                          }
                                          ?>
                                       </td>
            			...
            			<td colspan="6">
	            			<div class="btt-submit">
   								<div class="btt-submit-wrap">
   									<input id="dlall" class="btt-submit" type="submit" value="Thêm mới">
   								</div>
   							</div>
   						</td>
            		</tr>
